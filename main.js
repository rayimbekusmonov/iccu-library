...
i18n.ar = {
  ...i18n.en,
  brandSubtitle: "مكتبة مركز الحضارة الإسلامية في أوزبكستان",
  navHome: "الرئيسية",
  navDiscover: "المجموعات",
  navServices: "الخدمات",
  navVisit: "الزيارة",
  navAbout: "حول المكتبة",
  navPartners: "الشركاء",
  navDirectors: "فريق العمل",
  navKirish: "تسجيل الدخول",
  navRegister: "إنشاء حساب",
  heroEyebrow: "منصة التراث الرقمي",
  heroTitle: "استكشف مصادر الحضارة الإسلامية بمنظور عصري.",
  heroCopy: "تجمع مكتبة مركز الحضارة الإسلامية في أوزبكستان المخطوطات والكتب والمحاضرات والفعاليات وخدمات الزوار في منصة موحدة ميسرة.",
  heroPrimary: "البحث في المصادر",
  heroSecondary: "تصفح الأخبار",
  statBooks: "كتب",
  statManuscripts: "مخطوطات",
  statJournals: "دوريات",
  statAccess: "وصول عبر الإنترنت",
  updatesKicker: "المستجدات",
  newsTitle: "آخر الأخبار والإعلانات",
  newsSubtitle: "تحديثات هامة عن المنصة والفعاليات والاتفاقيات المشتركة.",
  newsTag1: "إعلان",
  newsHeadline1: "إضافة ٣٠٠٠ مخطوطة من العهد العثماني للأرشيف الرقمي",
  newsText1: "المجموعة الجديدة متاحة الآن مع البيانات الوصفية وآلية طلب الوصول.",
  newsBody1: "تم إعداد الأرشيف الرقمي لتيسير عمليات البحث عن المخطوطات وتقديم طلبات القراءة بسرعة وسهولة.",
  newsExtra1: "ستتكامل هذه السجلات في المرحلة المقبلة مع حساب الباحث الشخصي.",
  newsTag2: "فعالية",
  newsHeadline2: "بدء التسجيل في مؤتمر دراسات الحضارة الإسلامية",
  newsText2: "يتضمن المؤتمر محاضرات وورش عمل وجلسات خاصة حول المجموعات التاريخية.",
  newsBody2: "يهدف المؤتمر لربط مجموعات المكتبة ودراسات المصادر التاريخية بالأرشيف الرقمي.",
  newsExtra2: "سيتم إدراج جميع التسجيلات المرئية في الأرشيف المرئي بعد انتهاء المؤتمر.",
  newsTag3: "شراكة",
  newsHeadline3: "شراكة جديدة بين مركز الحضارة الإسلامية ومكتبة جامعة إسطنبول",
  newsText3: "تشمل الشراكة الفهرسة الموحدة وتبادل المصادر والرقمنة المشتركة.",
  newsBody3: "تفتح الاتفاقية آفاقاً عملية للتعامل مع المجموعات الدولية وتوحيد معايير البيانات الوصفية.",
  newsExtra3: "ستنعكس مخرجات هذه الشراكة في قسمي 'المصادر' و'الأعلام'.",
  quickKicker: "خدمات سريعة",
  quickTitle: "الخدمات الأساسية للمستخدمين",
  quickSubtitle: "روابط سريعة للوصول إلى المخطوطات وجدولة الزيارات وطلب الدعم المكتبي.",
  viewAll: "عرض الكل",
  qs1Title: "المخطوطات الرقمية",
  qs1Text: "تصفح المصادر النادرة وتقديم طلبات الحصول على إذن العرض.",
  qs1Link: "الانتقال للأرشيف ←",
  qs2Title: "دعم أمين المكتبة",
  qs2Text: "مساعدة في اختيار موضوعات البحث، وتحديد المصادر، وإعداد الببليوغرافيا.",
  qs2Link: "طلب الدعم ←",
  qs3Title: "تخطيط الزيارة",
  qs3Text: "مواعيد العمل، وقواعد قاعات القراءة، وشروط الاطلاع على المجموعات الخاصة.",
  qs3Link: "التفاصيل ←",
  projectsKicker: "مشاريع المنصة",
  projectsTitle: "مبادرات المكتبة الرقمية النشطة",
  projectsSubtitle: "مسارات عمل عملية تهدف لتحويل المكتبة إلى مرجع بحثي يومي.",
  project1Status: "نشط",
  project1Title: "الشراكات",
  project1Text: "مشاريع واتفاقيات تعاونية مشتركة مع الجامعات والمكتبات والمراكز العلمية.",
  project1Progress: "تعاون مستمر",
  project1Count: "١٠+ شركاء",
  project2Status: "٢٤/٧",
  project2Title: "الوصول عن بعد",
  project2Text: "إمكانية البحث في الفهرس الرقمي والمكتبات الإلكترونية من المنزل على مدار الساعة.",
  project2Progress: "متاحة دائماً",
  project2Count: "المكتبة الرقمية",
  project3Status: "أرشيف مباشر",
  project3Title: "أرشيف المحاضرات والندوات",
  project3Text: "ربط التسجيلات المرئية والنصوص المفرغة بمسارات المجموعات العلمية.",
  project3Progress: "مستمر",
  project3Count: "٥٠+ فيديو",
  project4Status: "نشط",
  project4Title: "الزيارات الجماعية والجولات",
  project4Text: "تنظيم جولات تعريفية في رحاب المكتبة للوفود الطلابية والمدارس والمؤسسات.",
  project4Progress: "باب الحجز مفتوح",
  project4Count: "تواصل معنا ←",
  partnersKicker: "الشركاء",
  partnersTitle: "شركاء نعتز بهم",
  partnersSubtitle: "نتعاون معاً للنهوض بالتراث الرقمي ودعم البحث العلمي.",
  newsDetailKicker: "تفاصيل الخبر",
  backNews: "العودة للأخبار",
  detailSideTitle: "مواضيع ذات صلة",
  detailSideText: "يرتبط هذا الخبر مباشرة بأعمال الفهرسة، ومجموعات الرقمنة، وحساب الباحث.",
  discoverKicker: "المجموعات",
  discoverTitle: "أقسام المجموعات",
  discoverSubtitle: "البحث في الفهرس الموحد، والمخطوطات، وتراجم الأعلام، والمعارض الرقمية.",
  d1Title: "الفهرس الإلكتروني",
  d1Text: "البحث عن الكتب، والمؤلفين، والموضوعات، والأرقام المعيارية.",
  d1f1: "أكثر من ١٢٠,٠٠٠ كتاب ومطبوعة",
  d1f2: "بحث متقدم بالكاتب، العنوان، سنة النشر، واللغة",
  d1f3: "البحث بواسطة المعرفات الدولية (ISBN, ISSN)",
  d1Cta: "دخول الفهرس ←",
  d2Title: "المخطوطات النادرة",
  d2Text: "مخطوطات تاريخية نادرة مع تفاصيل الوصول الرقمي.",
  d2f1: "أكثر من ١٥,٠٠0 مخطوطة نادرة في الأرشيف الرقمي",
  d2f2: "مجموعات العهود العثمانية، التيمورية، وغيرها من الحقب التاريخية",
  d2f3: "تنقية النتائج حسب الحقبة الزمنية، اللغة، وحالة المخطوط",
  d2Cta: "دخول الأرشيف ←",
  d3Title: "الأعلام والعلماء",
  d3Text: "نافذة معرفية مرتبطة ببوابة أعلام أوزبكستان allomalar.uz.",
  d3Link: "بوابة الأعلام ↗",
  d4Title: "المصادر التاريخية",
  d4Text: "رابط سريع للوصول إلى بوابة المصادر manbalar.uz.",
  d4Link: "بوابة المصادر ↗",
  d5Title: "المكتبة الإلكترونية",
  d5Text: "وصول كامل للكتب الرقمية والدوريات عبر البوابة e-library.cisc.uz.",
  d5Link: "المكتبة الإلكترونية ↗",
  servicesKicker: "الخدمات",
  servicesTitle: "باقة الخدمات المكتبيّة",
  servicesSubtitle: "خدمات متكاملة لدعم الأبحاث، وتسهيل الزيارات، وتيسير استخدام المجموعات الرقمية.",
  svc1Title: "استشر أمين المكتبة",
  svc1Text: "الحصول على استشارات أكاديمية وتوجيهات في إعداد مصادر البحوث والببليوغرافيا.",
  svc1f1: "اختيار المصادر والمراجع الملائمة لموضوع البحث",
  svc1f2: "تنسيق الاستشهادات والمراجع وفق المناهج العالمية (APA, MLA, Chicago)",
  svc1f3: "توجيه وإرشاد حول استخدام المجموعات المطبوعة والإلكترونية",
  svc1Cta: "إرسال طلب استشارة ←",
  svc2Title: "طلب الاطلاع على المجموعات الخاصة",
  svc2Text: "تقديم طلب مسبق للاطلاع على المخطوطات والوثائق النادرة داخل القاعات.",
  svc2f1: "حجز المخطوطات النادرة والمواد الأرشيفية المحفوظة",
  svc2f2: "إمكانية الحجز المسبق إلكترونياً قبل موعد الزيارة",
  svc2f3: "توفير النسخ الرقمية والمصورات لأغراض البحث العلمي",
  svc2Cta: "تقديم طلب اطلاع ←",
  svc3Title: "الشراكات والتعاون",
  svc3Text: "مشاريع بحثية علمية مشتركة بالتعاون مع الجامعات ومراكز البحث الدولية.",
  svc4Title: "الوصول عن بعد",
  svc4Text: "إمكانية البحث في الفهرس الرقمي والمكتبات الإلكترونية من المنزل على مدار الساعة.",
  svc5Title: "الزيارات الجماعية والجولات",
  svc5Text: "تنظيم جولات تعريفية في رحاب المكتبة للوفود الطلابية والمدارس والمؤسسات.",
  svcContact: "تواصل معنا ←",
  svcOpen: "فتح الرابط ←",
  visitKicker: "الزيارة",
  visitTitle: "خطط لزيارتك",
  visitSubtitle: "مواعيد العمل، الموقع الجغرافي، وقواعد قاعة القراءة.",
  hoursTitle: "مواعيد العمل",
  weekday: "الإثنين – الجمعة: ٠٩:٠٠ – ١٨:٠٠",
  saturday: "السبت: ١٠:٠٠ – ١٦:٠٠",
  sunday: "الأحد: مغلق",
  contactTitle: "العنوان والاتصال",
  address: "العنوان: طشقند، أوزبكستان",
  email: "البريد الإلكتروني: library@iccu.example",
  phone: "الهاتف: ٠٠ ٠٠ ٠٠٠ ٩٩٨ ٩٩٨+",
  rulesTitle: "تعليمات وقواعد المكتبة",
  rule1: "يرجى التزام الهدوء التام داخل قاعات القراءة.",
  rule2: "يمنع إدخال الأطعمة والمشروبات إلى قاعات المجموعات والكتب.",
  rule3: "تصوير المخطوطات والوثائق النادرة يتطلب إذناً خطياً مسبقاً.",
  beforeTitle: "قبل الحضور",
  beforeText: "يرجى إحضار وثيقة إثبات الشخصية وحجز المواد النادرة إلكترونياً قبل موعد الحضور.",
  mapText: "الخريطة التفاعلية للمبنى",
  aboutKicker: "عن المكتبة",
  aboutTitle: "نبذة عن المكتبة",
  aboutSubtitle: "تعمل مكتبة مركز الحضارة الإسلامية على حفظ ودراسة ونشر تراث الحضارة الإسلامية العريق.",
  mission1Title: "حفظ التراث",
  mission1Text: "رقمنة وصيانة المخطوطات والكتب النادرة، مع تركيب بطاقات التعريف اللاسلكية RFID لأكثر من ٣٠,٠٠٠ كتاب.",
  mission2Title: "تيسير الوصول",
  mission2Text: "إتاحة سبل العلم والمعرفة المفتوحة للطلاب والباحثين وعموم المهتمين.",
  faq1Q: "كيف يمكنني استخراج بطاقة العضوية؟",
  faq1A: "يرجى التوجه إلى مكتب التسجيل مصطحباً بطاقة الهوية الشخصية.",
  faq2Q: "هل يمكنني تصفح المصادر الرقمية من المنزل؟",
  faq2A: "العديد من المصادر متاحة رقمياً مجاناً، غير أن بعض قواعد البيانات تتطلب تسجيل الدخول بحساب العضوية.",
  footerText: "البوابة الرقمية الموحدة للمجموعات النادرة، وخدمات الزوار، والمصادر البحثية الأكاديمية.",
  footerContacts: "اتصل بنا",
  footerLinks: "روابط سريعة",
  footerSocials: "حسابات التواصل الاجتماعي",
  footerRights: "مركز الحضارة الإسلامية في أوزبكستان — جميع الحقوق محفوظة",
  directorsKicker: "فريق العمل",
  directorsTitle: "إدارة المكتبة",
  directorsSubtitle: "نخبة من الكفاءات المسؤولة عن تطوير وتشغيل مكتبة مركز الحضارة الإسلامية.",
  director1Name: "قادروف روشان عزيزوفيتش",
  director1Role: "المدير العام",
  director1Bio: "يتولى الإشراف العام على تشغيل مكتبة مركز الحضارة الإسلامية وتوجيه مشاريع البحث العلمي والرقمنة.",
  director2Name: "إسلاموفا مقدّس شاغلاموفنا",
  director2Role: "أخصائي أول مخطوطات",
  director2Bio: "تتولى أعمال تصنيف وفهرسة المخطوطات والكتب النادرة والطباعة الحجرية وإجراء البحوث العلمية عليها.",
  director3Name: "نعمتوفا سيفارا إيرغاشيفنا",
  director3Role: "أخصائي أول قواعد بيانات",
  director3Bio: "تتولى إدارة عمليات التزويد وتنمية مجموعات المكتبة وتطوير قواعد البيانات الرقمية.",
  director4Name: "سعدييفا خيرامان خالخوجاييفنا",
  director4Role: "أخصائي أول علاقات دولية",
  director4Bio: "تتولى بناء الشراكات الدولية وتنسيق مشاريع التعاون المشترك وتبادل الخبرات العالمية.",
  director5Name: "كريمتوفا مولودة أنفاروفنا",
  director5Role: "أخصائي أول خدمات المستفيدين",
  director5Bio: "تتولى الإشراف على خدمات القراء وتنسيق قاعات المطالعة وتوفير الخدمات المكتبية والمعلوماتية عن بعد.",
  navAnnouncements: "الإعلانات",
  kioskLabel: "إعلان جديد",
  kioskDefaultTitle: "جاري تحميل الإعلان...",
  kioskViewAll: "التفاصيل ←",
  announcementsKicker: "الإعلانات",
  announcementsTitle: "آخر الإعلانات",
  announcementsSubtitle: "مستجدات وإعلانات هامة حول خدمات المكتبة وأنشطة المنصة الرقمية.",
  announcementsEmpty: "لا توجد إعلانات نشطة حالياً.",
  annPriority: "إعلان",
  annPriorityHigh: "هام جداً",
  navMap: "الخريطة",
  nav3D: "جولة ثلاثية الأبعاد",
  close: "إغلاق",
  zoomIn: "تكبير",
  zoomOut: "تصغير",
  resetSize: "إعادة ضبط",
  ariaHome: "الذهاب للرئيسية",
  ariaMenu: "فتح القائمة",
  regTitle: "إنشاء حساب",
  regSubtitle: "سجل بياناتك للوصول الكامل لكافة خدمات وأنظمة المكتبة الرقمية.",
  regNameLabel: "الاسم واللقب",
  regNamePlaceholder: "محمد علي",
  regEmailLabel: "البريد الإلكتروني",
  regPasswordLabel: "كلمة المرور",
  regSubmit: "تأكيد التسجيل",
  regSuccess: "تم التسجيل بنجاح! مرحباً بك.",
  partnerBnf: "المكتبة الوطنية الفرنسية",
  partnerLoc: "مكتبة الكونغرس الأمريكية",
  partnerIstanbul: "جامعة إسطنبول",
  partnerOzmu: "جامعة أوزبكستان الوطنية",
  partnerTurkiston: "مكتبة تركستان العامة",
  floorPlanFallback: "يرجى إدراج ملف floor-plan.svg<br>داخل مجلد images/",
  footerAddress: "طاشقند، أوزبكستان",
  directorBadge: "المدير العام",
  tour3dKicker: "جولة افتراضية",
  tour3dTitle: "جولة افتراضية ثلاثية الأبعاد",
  tour3dSubtitle: "استكشف أروقة وقاعات المكتبة عن بعد من خلال النموذج التفاعلي. انقر على النقاط التعريفية للمزيد من التفاصيل.",
  tdAutoRotate: "دوران تلقائي",
  tdReset: "إعادة ضبط الكاميرا",
  tdFullscreen: "ملء الشاشة",
  tdHint: "اسحب للتدوير · حرك الفأرة للتقريب · انقر على النقاط المضيئة",
  tdHallReadingTitle: "قاعة المطالعة الرئيسية",
  tdHallReadingDesc: "قاعة مطالعة عصرية ومضيئة تتسع لأكثر من ٢٠٠ قارئ، تتيح الاطلاع على المراجع والكتب الدراسية واستخدام الحواسب الرقمية.",
  tdHallManuscriptsTitle: "خزانة المخطوطات والوثائق",
  tdHallManuscriptsDesc: "تضم أكثر من ١٥,٠٠٠ مخطوطة وكتاب حجري نادر تغطي مختلف علوم الحضارة الإسلامية، وتخضع لرقابة حرارية وبيئية دقيقة.",
  tdHallDigiTitle: "مختبر الرقمنة والترميم",
  tdHallDigiDesc: "مركز تقني متكامل لمسح المصادر التاريخية وتصويرها بدقة فائقة لحفظها رقمياً وإتاحتها لأجيال الغد.",
  tdHallGalleryTitle: "معرض المقتنيات الأثرية",
  tdHallGalleryDesc: "قاعة مفتوحة للزوار تعرض أقدم المخطوطات، ونماذج الخط العربي، وقطعاً من تراث الفن الإسلامي العريق.",
  floorPlanBtn: "عرض خريطة المكتبة الداخلية",
  floorPlanKicker: "الخريطة الداخلية",
  floorPlanTitle: "مخطط قاعات القراءة والمجموعات",
  floorPlanHint: "استخدم عجلة الفأرة للتكبير والتصغير · اسحب لتحريك الخريطة",
  abStat1: "إجمالي الكتب والمطبوعات",
  abStat2: "النسخ الرقمية",
  abStat3: "المخطوطات والوثائق",
  abStat4: "مساحة المكتبة",
  abStat5: "سعة قاعات المطالعة",
  abStat6: "المصادر النادرة المرقمنة",
  aboutFondKicker: "عن المجموعات",
  aboutFondTitle: "حصيلة عام ٢٠٢٥",
  abH1: "المطبوعات والكتب الجديدة",
  abH1sub: "٣,٨٧٩ إهداء، ٩١٠ شراء",
  abH2: "المصادر المكتوبة بالموحدة",
  abH2sub: "المخطوطات والكتب الحجرية",
  abH3: "سجل حصر وتوصيف المصادر",
  abH3sub: "المصادر التي تم إعداد بطاقات تعريفية لها",
  abH4: "كتب بطريقة برايل",
  abH4sub: "مخصصة للمكفوفين وضعاف البصر",
  mission3Title: "التطوير والتحديث",
  mission3Text: "التوسع في خدمات المكتبات الذكية، الحفاظ على التراث المكتوب، وتدشين مشاريع تعاون علمية تسهم في ريادة المعرفة.",
  faq3Q: "ما هي السعة الاستيعابية للمكتبة؟",
  faq3A: "يمكن للمكتبة خدمة ٣١٠ قارئ ومستفيد في وقت واحد.",
  faq4Q: "هل يسمح بالاطلاع المباشر على المخطوطات والكتب النادرة؟",
  faq4A: "نعم، يتاح الاطلاع على المجموعات النادرة داخل قاعات مخصصة بناءً على حجز وإذن مسبق من قسم الرقمنة والترميم.",
...
function setLang(lang) {
  ...
  const flagMap = { uz:"uz", en:"gb", ru:"ru", tr:"tr", ar:"sa" };
...
function applyTexts() {
  ...
  if (liveAnnouncements && liveAnnouncements.length) {
    ...
    const demoTitles = {
      ...
      ar: "مرحبًا بكم في المكتبة! تابعوا الخدمات والفعاليات الجديدة.",
    };
...
function renderNewsGrid() {
  ...
  grid.innerHTML = slice.map(n => {
    ...
    const moreLabel = { uz:"Batafsil", en:"Read more", ru:"Подробнее", tr:"Devamı", ar:"المزيد" }[lang] || "Batafsil";
    ...
    return `<article class="news-card" tabindex="0" role="button"
      ...
      <div class="news-body">
        ...
        <h3>${headline}</h3>
        <p>${preview}</p>
        <button class="news-more-btn" onclick="openNews(${n.id})">${moreLabel} ${lang === 'ar' ? '←' : '→'}</button>
...
function formatDate(iso, lang) {
  ...
  const localeMap = { uz:"uz-UZ", en:"en-GB", ru:"ru-RU", tr:"tr-TR", ar:"ar-SA" };
